<x-main>
    ...
    <div class="flex justify-between items-center mb-8">
        ...
        <a href="{{ route('admin.tambahPerizinan') }}"
    ...
    <div id="modal-{{ $item->id }}"
        ...
        <div class="bg-white w-full max-w-xl rounded-2xl shadow-xl flex flex-col max-h-[90vh]">
            ...
            <div class="p-6 space-y-6 text-sm overflow-y-auto">
                ...
                @if (optional($item->verifikasi)->admin_verified_at != null)
                    ...
                    @if (optional($item->verifikasi)->superadmin_verified_at != null)
                    <div class="bg-green-50 border-l-4 border-green-400 p-4">
                        <p class="text-green-700 text-sm">
                    ...
                    @if (optional($item->verifikasi)->status_admin == 'ditolak')
                    ...
                    @if (optional($item->verifikasi)->status_superadmin == 'ditolak')
                    <div class="bg-red-50 border-l-4 border-red-400 p-4">
                        <p class="text-red-700 text-sm">
                            <span class="font-medium">Alasan Penolakan:</span>
